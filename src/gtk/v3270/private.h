...
/*--[ Globals ]--------------------------------------------------------------------------------------*/
 ...
 #define V3270_CURSOR_NORMAL					LIB3270_CURSOR_NORMAL
 #define V3270_CURSOR_WAITING					LIB3270_CURSOR_WAITING
 #define V3270_CURSOR_LOCKED					LIB3270_CURSOR_LOCKED

 #define V3270_CURSOR_MOVE_SELECTION			LIB3270_CURSOR_USER
 #define V3270_CURSOR_SELECTION_TOP_LEFT		LIB3270_CURSOR_USER+1
 #define V3270_CURSOR_SELECTION_TOP_RIGHT		LIB3270_CURSOR_USER+2
 #define V3270_CURSOR_SELECTION_TOP				LIB3270_CURSOR_USER+3
 #define V3270_CURSOR_SELECTION_BOTTOM_LEFT		LIB3270_CURSOR_USER+4
 #define V3270_CURSOR_SELECTION_BOTTOM_RIGHT	LIB3270_CURSOR_USER+5
 #define V3270_CURSOR_SELECTION_BOTTOM			LIB3270_CURSOR_USER+6
 #define V3270_CURSOR_SELECTION_LEFT			LIB3270_CURSOR_USER+7
 #define V3270_CURSOR_SELECTION_RIGHT			LIB3270_CURSOR_USER+8
