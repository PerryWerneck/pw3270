...
LIB3270_INTERNAL void ft_dft_data(unsigned char *data, int length);
LIB3270_INTERNAL void dft_read_modified(void);
LIB3270_INTERNAL void set_dft_buffersize(void);
